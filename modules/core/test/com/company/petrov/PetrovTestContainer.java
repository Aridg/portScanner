...
public class PetrovTestContainer extends TestContainer {

    public PetrovTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/petrov/app.properties",
    ...
    public static class Common extends PetrovTestContainer {

        public static final PetrovTestContainer.Common INSTANCE = new PetrovTestContainer.Common();
